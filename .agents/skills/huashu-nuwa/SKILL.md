...
### 每个Agent的硬性要求（超级搜索版）
- **最低来源数量**：每个Agent必须获取至少**30条**有效来源
- **深度要求**：必须包含至少**40%**的一手来源（本人著作、直接访谈）
- **广度要求**：来源类型必须多样化（书籍、文章、视频、播客、学术论文等）
- **注明信息来源**：每条信息必须标注来源URL和可信度（一手>二手>推测）
...
**所有12个Agent完成后，暂停展示调研质量摘要**：

```
┌─────────────────────┬──────────┬──────────────────────────┐
│ Agent               │ 来源数量  │ 关键发现                  │
├─────────────────────┼──────────┼──────────────────────────┤
│ 1 著作              │ 30+篇    │ 核心论点、自创术语、知识谱系│
│ 2 对话              │ 20+段    │ 即兴反应、问答模式        │
│ 3 表达              │ 100+条   │ 高频词、句式特征          │
│ 4 他者              │ 15+篇    │ 批评、评价、对比          │
│ 5 决策              │ 10+个    │ 关键决策、逻辑框架        │
│ 6 时间线            │ 完整      │ 里程碑、思想转折点        │
│ 7 思想体系          │ 20+项    │ 理论架构、方法论          │
│ 8 即兴反应          │ 15+次    │ 临场发挥、压力下决策      │
│ 9 最新动态          │ 10+条    │ 近期活动、最新观点        │
│ 10 工作方法         │ 15+项    │ 习惯、流程、效率技巧      │
│ 11 争议事件         │ 5+起     │ 争议焦点、不同立场        │
│ 12 跨域影响         │ 10+项    │ 跨界应用、社会影响        │
├─────────────────────┼──────────┼──────────────────────────┤
│ 总计来源            │ 200+条   │                          │
│ 一手来源占比        │ ≥30%     │                          │
